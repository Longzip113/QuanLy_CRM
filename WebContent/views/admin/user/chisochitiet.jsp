						...
						<div class="widget-box">
							...
							<div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div id="piechart-placeholder" style="width: 90%; min-height: 150px; padding: 0px; position: relative;"><canvas class="flot-base" width="836" height="300" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 418px; height: 150px;"></canvas><canvas class="flot-overlay" width="836" height="300"
                                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 418px; height: 150px;"></canvas>
                                                    <div class="legend">
                                                        <div style="position: absolute; width: 90px; height: 110px; top: 15px; right: -30px; background-color: rgb(255, 255, 255); opacity: 0.85;"> </div>
